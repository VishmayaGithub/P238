...
#create Flask group to manage the dictionaries
#Create commands to manga the flask app
#Used to run adn start the app
...
#Stores the information about the products
product_json = [
	{
...
#Reset the database each time it is run
...
def seeder():
	for user in user_json:
		#creating each user by calling create function
...
@cli.command()
#Calls both the recreate_db and seeder function
#Especially call just this function when running
def rsd():
...
#To start the program or application
